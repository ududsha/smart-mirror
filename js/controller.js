(function(angular) {
    ...
    function MirrorCtrl(AnnyangService, GeolocationService, WeatherService, MapService, HueService, CalendarService, XKCDService, PythonService, $scope, $timeout, $interval) {
        var _this = this;
